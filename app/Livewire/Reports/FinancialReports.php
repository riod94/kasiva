...
class FinancialReports extends Component
{
    ...
    public function exportPdf()
    {
        ...
        return app(ReportExportService::class)->exportPdf($data);
    }
    ...
    public function exportExcel()
    {
        ...
        return app(ReportExportService::class)->exportExcel($data);
    }

    public function getReportData(): array
    {
        $queryTx = Transaction::query()->where(function ($q) {

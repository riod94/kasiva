<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="bg-[#1E1B4B] border border-[#2E2A68] rounded-3xl p-6 shadow-xl space-y-4 text-xs">
        ...
        <div>
            ...
            <textarea wire:model="address" rows="3" class="w-full px-4 py-3 bg-[#16192E] border border-[#2E2A68] rounded-2xl text-white font-medium placeholder-slate-500 focus:outline-none focus:border-[#00AAA6] transition"></textarea>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-3 border-t border-[#2E2A68]">
            <div>
                ...
                <input type="number" step="0.1" wire:model="tax_percentage" class="w-full px-4 py-3 bg-[#16192E] border border-[#2E2A68] rounded-2xl text-white font-black text-sm placeholder-slate-500 focus:outline-none focus:border-[#00AAA6] transition">
            ...
            <div>
                ...
                <input type="number" step="0.1" wire:model="service_charge_percentage" class="w-full px-4 py-3 bg-[#16192E] border border-[#2E2A68] rounded-2xl text-white font-black text-sm placeholder-slate-500 focus:outline-none focus:border-[#00AAA6] transition">

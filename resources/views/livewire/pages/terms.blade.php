    ...
    <main class="flex-1">
        ...
        <section class="py-12 md:py-16 max-w-4xl mx-auto px-4 space-y-6">
            ...
            <div class="bg-gradient-to-br from-[#4338CA]/20 to-[#1E1B4B] p-6 md:p-8 rounded-3xl border border-[#4338CA]/40 text-center space-y-3">
                ...
                <a href="mailto:support@kasiva.id" class="inline-flex items-center justify-center px-6 py-2.5 bg-[#4338CA] hover:bg-[#3730A3] text-white font-bold text-xs rounded-xl shadow transition">
                    support@kasiva.id
                </a>
            </div>
        </section>

    ...
    <div class="bg-[#1E1B4B] border border-[#2E2A68] w-full max-w-sm rounded-3xl p-7 space-y-6 shadow-2xl backdrop-blur-xl">
        ...
        <form wire:submit.prevent="login" class="space-y-4 text-xs">
            <div>
                ...
                <input type="email" wire:model="email" placeholder="kasir@kasiva.pos" class="w-full px-3.5 py-3 bg-[#16192E] border border-[#2E2A68] rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-[#00AAA6] transition">
            ...
            <div>
                ...
                <input type="password" wire:model="password" placeholder="••••••••" class="w-full px-3.5 py-3 bg-[#16192E] border border-[#2E2A68] rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-[#00AAA6] transition">
            ...
            <div class="flex items-center justify-between text-[11px] pt-1">
                <label class="flex items-center gap-2 text-slate-400 cursor-pointer font-medium hover:text-slate-300">
                    <input type="checkbox" wire:model="remember" class="rounded bg-[#16192E] border-[#2E2A68] text-[#00AAA6] focus:ring-0">
                    Ingat saya
                </label>

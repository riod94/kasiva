<div class="min-h-screen flex items-center justify-center p-4 bg-[#0F172A] text-slate-100 selection:bg-[#00AAA6]/30 selection:text-[#3EDAD7]">
    <div class="bg-[#1E1B4B] border border-[#2E2A68] w-full max-w-sm rounded-3xl p-7 space-y-5 shadow-2xl backdrop-blur-xl">
        ...
        <form wire:submit.prevent="register" class="space-y-3.5 text-xs">
            <div>
                ...
                <input type="text" wire:model="outlet_name" placeholder="cth: Kedai Kopi Kasiva" class="w-full px-3.5 py-2.5 bg-[#16192E] border border-[#2E2A68] rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-[#00AAA6] transition">
            ...
            <div>
                ...
                <input type="text" wire:model="name" placeholder="cth: Rizki Pratama" class="w-full px-3.5 py-2.5 bg-[#16192E] border border-[#2E2A68] rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-[#00AAA6] transition">
            ...
            <div>
                ...
                <input type="email" wire:model="email" placeholder="owner@outlet.com" class="w-full px-3.5 py-2.5 bg-[#16192E] border border-[#2E2A68] rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-[#00AAA6] transition">
            ...
            <div>
                ...
                <input type="text" wire:model="phone" placeholder="081234567890" class="w-full px-3.5 py-2.5 bg-[#16192E] border border-[#2E2A68] rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-[#00AAA6] transition">
            </div>

            <div>
                <label class="block font-bold text-slate-300 mb-1 uppercase tracking-wider text-[10px]">Kata Sandi</label>
                <input type="password" wire:model="password" placeholder="Minimal 6 karakter" class="w-full px-3.5 py-2.5 bg-[#16192E] border border-[#2E2A68] rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-[#00AAA6] transition">
                @error('password') <span class="text-rose-400 text-[10px] mt-1 block">{{ $message }}</span> @enderror
            </div>

            <button type="submit" class="w-full py-3.5 bg-[#00AAA6] hover:bg-[#008F8C] text-white font-extrabold text-xs uppercase tracking-wider rounded-2xl shadow-lg transition active:scale-95 flex items-center justify-center gap-2">
